...
<body>
    ...
    <section class="ftco-section bg-light">
        <div class="container">
            ...
            <h4>Agenda de {{ $medico->usuario->name}}</h4>
            <div class="row">
                <div class="col-6"><button class="btn btn-primary"><i class="fa fa-arrow-left"></i> Anterior</button></div>
                <div class="col-6"><span class="float-right"><button class="btn btn-primary">Siguiente <i class="fa fa-arrow-right "></i>  </button></span></div>
            </div>
            @php echo $semana @endphp
        </div>
        </div>
    </section>
    {!! Form::close() !!}
