    ...
    <link href="{{ URL::asset('nifty/demo/css/demo/nifty-demo-icons.min.css') }}" rel="stylesheet">

    <!--Pace - Page Load Progress Par [OPTIONAL]-->
    <link href="{{ URL::asset('nifty/demo/plugins/pace/pace.min.css') }}" rel="stylesheet">
    <script src="{{ URL::asset('nifty/demo/plugins/pace/pace.min.js') }}"></script>


    <!--Demo [ DEMONSTRATION ]-->
    <link href="{{ URL::asset('nifty/demo/css/demo/nifty-demo.min.css') }}" rel="stylesheet">
        
    <!--Bootstrap Validator [ OPTIONAL ]-->
    <link href="{{ URL::asset('nifty/demo/plugins/bootstrap-validator/bootstrapValidator.min.css') }}" rel="stylesheet">
...
<div id="page-content">
    ...
    <!--jQuery [ REQUIRED ]-->
    <script src="{{ URL::asset('nifty/demo/js/jquery.min.js') }}"></script>

    <!--BootstrapJS [ RECOMMENDED ]-->
    <script src="{{ URL::asset('nifty/demo/js/bootstrap.min.js') }}"></script>

    <!--NiftyJS [ RECOMMENDED ]-->
    <script src="{{ URL::asset('nifty/demo/js/nifty.min.js') }}"></script>

    <!--=================================================-->
    
    <!--Demo script [ DEMONSTRATION ]-->
    <script src="{{ URL::asset('nifty/demo/js/demo/nifty-demo.min.js') }}"></script>

    <!--Bootstrap Wizard [ OPTIONAL ]-->
    <script src="{{ URL::asset('nifty/demo/plugins/bootstrap-wizard/jquery.bootstrap.wizard.min.js') }}"></script>

    <!--Bootstrap Validator [ OPTIONAL ]-->
    <script src="{{ URL::asset('nifty/demo/plugins/bootstrap-validator/bootstrapValidator.min.js') }}"></script>

    <!--Form Wizard [ SAMPLE ]-->
    <script src="{{ URL::asset('nifty/demo/js/demo/form-wizard.js"') }}></script>
