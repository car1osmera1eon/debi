        ...
        @foreach($agendas as $agenda)
            <tr>
                ...
                <td>
                    ...
                    <div class='btn-group'>
                        <a href="{{ route('fromOdonts.paciente',[$agenda->paciente_id]) }}" class='btn btn-primary btn-icon' title="Atención"><i class="pli-folder-with-document"></i></a>
                        <a href="{{ route('agendas.show', [$agenda->id]) }}" class='btn btn-default btn-icon' title="Ver"><i class="pli-eye"></i></a>
                        <a href="{{ route('agendas.edit', [$agenda->id]) }}" class='btn btn-default btn-icon' title="Editar"><i class="pli-file-edit"></i></a>
